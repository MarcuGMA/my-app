        ...
        <div className="newsMain__content">
          <div className="content_row">
            <div className="content_row__item">
              <img src="https://th.bing.com/th/id/OIP.tDeRS9HeebryZwVIpPfPogHaEK?pid=ImgDet&rs=1" alt="" />
              <h3>NEWS</h3>
              <h2>God of War</h2>
              <p>
          ...
          <div className="content_row_2">
            ...
            <div className="content_row__item">
              <img src="https://th.bing.com/th/id/R.7578bd819b0908ccf860e4d319499e0a?rik=56xc3UkitnNSog&pid=ImgRaw&r=0" alt="" />
              <h3>NEWS</h3>
              <h2>Hearthstone</h2>
              <p>
                It takes a ton of intelligence, careful planning, and pure luck
          ...
          <div className="content_row_3">
            ...
            <div className="content_row__item">
              <img src="https://www.indiegamewebsite.com/wp-content/uploads/2020/02/hades-scaled.jpg" alt="" />
              <h3>NEWS</h3>
              <h2>Hades</h2>
              <p>
